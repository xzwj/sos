...
#panghw 处理paper_outhors和paper_journal字段
train['paper_authors']=train.paper_authors.map(lambda x:text_to_wordlist(str(x)))
train['paper_journal']=train.paper_journal.map(lambda x:text_to_wordlist(str(x)))
...
#panghw 处理paper_outhors和paper_journal字段
test_paper['paper_authors']=test_paper.paper_authors.map(lambda x:text_to_wordlist(str(x)))
test_paper['paper_journal']=test_paper.paper_journal.map(lambda x:text_to_wordlist(str(x)))
logger.success('Process test data...')

#新增序列化paper_outhors和paper_journal
train_qs = pd.Series(train['press_headline'].tolist() + train['paper_title'].tolist() + train['press_text'].tolist()
                     + train['paper_authors'].tolist() + train['paper_journal'].tolist() + test_press['press_headline'].tolist()
                     + test_press['press_text'].tolist() + test_paper['paper_title'].tolist() + test_paper['paper_authors'].tolist()
                     + test_paper['paper_journal'].tolist()).astype(str)
